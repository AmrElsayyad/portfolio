...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Software Engineer 🚀 with experience building software solutions with C / C++20 / Java / Spring Framework / Python / TypeScript / Angular / JavaScript / ReactJS and some other cool libraries and frameworks."
  ),
  resumeLink:
